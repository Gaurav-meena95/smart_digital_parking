                ...
                {navItems.map((item) => {
                    ...
                    return (
                        <Link
                            key={item.path}
                            to={item.path}
                            className={`flex flex-col lg:flex-row items-center gap-2 lg:gap-3 px-6 py-1 lg:py-2 rounded-xl transition-all ${isActive
                                    ? 'text-indigo-600 bg-indigo-50'
                                    : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                                }`}
                        >
                            <div
                                className={`w-6 h-6 lg:w-8 lg:h-8 flex items-center justify-center rounded-xl transition-all ${isActive ? 'bg-linear-to-r from-indigo-50 to-purple-50' : ''
                                    }`}
                            >
